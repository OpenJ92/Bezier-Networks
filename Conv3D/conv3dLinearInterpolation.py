...
class Conv3dInterpolation():
    ...
    contract(self, shape_in, shape_out) - construct a Conv3DTranspose operation given shape state in construct_InterpolationNetwork
    dialate(self, shape_in, shape_out) - construct a Conv3D operation given shape state in construct_InterpolationNetwork
    warp(self, shape_in, shape_out) - construct an itterated Conv3d to Conv3DTranspose provided dimension delta are not all monotonic (increase/decrease)
